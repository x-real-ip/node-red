...
[![Check releases](https://github.com/x-real-ip/node-red/actions/workflows/new-release-monitor.yaml/badge.svg)](https://github.com/x-real-ip/node-red/actions/workflows/new-release-monitor.yaml)
